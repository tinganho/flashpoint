...
namespace flashpoint::program {
    ...
    DiagnosticMessageTemplate D::Cannot_add_an_interface_in_type_location = DiagnosticMessageTemplate { "Cannot add an interface in type location." };
    ...
    DiagnosticMessageTemplate D::Expected_interface_reference = DiagnosticMessageTemplate { "Expected interface reference." };
    ...
    DiagnosticMessageTemplate D::The_object_0_is_not_part_of_the_union_1 = DiagnosticMessageTemplate { "The object '{0}' is not part of the union '{1}'." };
